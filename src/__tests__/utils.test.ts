...
describe("getSystemPromptMsg", () => {
  it("should return the system content field from request-intake.prompt.yml", () => {
    ...
    expect(
      getSystemPromptMsg("request-intake.prompt.yml", ".github/Prompts"),
    ).toEqual(requestIntakePrompt);
  });

  it("should return the system content field from bug-review.prompt.yml", () => {
    ...
    expect(
      getSystemPromptMsg("bug-review.prompt.yml", ".github/Prompts"),
    ).toEqual(bugIntakePrompt);
  });
});
